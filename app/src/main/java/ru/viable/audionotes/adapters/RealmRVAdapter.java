 ...
 */
public abstract class RealmRVAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
     ...
     *                   changes.
     * @see #RealmRVAdapter(OrderedRealmCollection, boolean, boolean)
     */
    public RealmRVAdapter(@Nullable OrderedRealmCollection<T> data, boolean autoUpdate) {
